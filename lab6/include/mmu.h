...
#include "stddef.h"                                                    // tcr_el1: The control register for stage 1 of the EL1&0 translation regime.
...
#define MMU_PTE_ADDR (MMU_PGD_BASE + 0x3000L)
...
void walk(size_t *pgd_p, size_t va, size_t pa, size_t flag);
